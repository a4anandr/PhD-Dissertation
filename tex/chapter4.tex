...
Filtering experiments were performed using the various FPF gain function approximation approaches discussed in this paper. Additionally, comparisons are made with conventional techniques: the extended Kalman filter (EKF), and \textit{sequential importance sampling} particle filter (SIS PF).
